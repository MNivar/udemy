...
//friend Movie::increment_watched();
//friend Movie::get_name();
//friend Movie::get_rating();
//friend Movie::get_watched();

private:
    std::vector<Movie> movies; //a vector made out of movie objects 
public:
    Movies();             // Constructor
    ~Movies();          // Destructor
